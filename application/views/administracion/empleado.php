...
<div class="widgetTitle">
    <h5><i class="glyphicon glyphicon-ok"></i> ACTUALIZACI襈 DE DATOS</h5>
</div>
<div class='well'>
    <form method="post" id="fusuario" action='<?php echo base_url('index.php/administracion/guardarempleado'); ?>' onsubmit="return obligatorio('1')">
        ...
        <div class="row">
            <div  class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                <label for="usu_cc">Identificaci贸n</label><input type="text" value="<?php echo $usuario[0]['usu_cc'] ?>" class="form-control obligatorio" name="usu_cc" id="usu_cc">
            </div>
            <div  class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                <label for="usu_fecha_expedicion_cc">Fecha de expedici贸n documento</label>
        ...
        <div  class="row">
            ...
            <div  class="col-lg-4 col-md-4 col-xs-4 col-sm-4">
                <label for="usu_confir_caja_compensacio">Tiene caja compensaci贸n</label>
        ...
        <div class="row">
            <div  class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                <label for="usu_desplazamiento_mision">Realiza desplazamientos en misi贸n</label>
        ...
        <div class="row">
            ...
            <div  class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                <label for="usu_fecha_vigencia_licencia">Fecha de expedici贸n</label>
        ...
        <div class="row">
            <div  class="col-lg-3 col-md-3 col-xs-3 col-sm-3">
                <label for="usu_experiecia_anos">Experiencia en a帽os de conduccion</label>
