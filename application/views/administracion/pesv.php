                                    ...
                                    <?php if (empty($especificos)) { ?>
                                        ...
                                        foreach ($especificos as $esp) {
                                            ...
                                            <div class="principal">
                                                ...
                                                <div align="center" class="col-lg-2 col-sm-2 col-xs-2 col-md-2"><button type="button" class="btn btn-info agregarespecifico">Agregar</button></div>
                                                <div esp="" align="center" class="col-lg-2 col-sm-2 col-xs-2 col-md-2"><button doc="<?php echo $esp['objEsp_id'] ?>" dato="especifico"  type="button" class="btn btn-danger eliminarpecifico">Eliminar</button></div>
