...
if ($contador == 0) {
    ...
    foreach ($i as $tipo => $preguntaopcion) {
        ...
        echo "<tr ><td colspan='4' align='center' style='background-color:blue;color:white'><b>" . $tipo . "</b></td></tr>";
        foreach ($preguntaopcion as $opcion => $opcionpregunta) {
            
            echo "<tr class='widgetTitle'><td  style='width:85%'><b>" . $opcion . "</b></td>
            ...
            foreach ($opcionpregunta as $id => $pregunta) {
                ...
                echo "<tr><td>" . $pregunta . "</td><td>
                    ...
                    <td><input type='checkbox' value='".$id."' name='no[]' class='seleccionado' ></td>
                    <td><input type='checkbox' value='".$id."' name='na[]' class='seleccionado' ></td>
                    </tr>";
            }
        }
        echo "</table>
