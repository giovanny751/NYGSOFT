...
--
-- Servidor: localhost
-- Tiempo de generación: 02-02-2015 a las 23:14:36
...
-- Base de datos: `gyy`
--
CREATE DATABASE IF NOT EXISTS `gyy` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `gyy`;
...
(3, '127.0.0.1', 'administrator', '$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36', '', 'admin@admin.com', '', NULL, NULL, NULL, 1268889823, 1422912082, 1, 'Admin', 'istrator', 'ADMIN', '0'),
